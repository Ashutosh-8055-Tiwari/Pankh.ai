...
export const Footer = () => {
  return (
    <div className="  p-12 mt-36 dark:bg-gray-900 dark:text-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:space-x-8">
        <div className="flex flex-col w-[50%] justify-between mb-8 md:mb-0">
          <h2 className="text-[24px] leading-[36px] font-[400] text-[#000000] dark:text-white ">Site name</h2>
        ...
        <div className="flex-1 mb-8 md:mb-0 ">
          ...
          <ul className="mt-2 space-y-1">
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
          </ul>
        ...
        <div className="flex-1 mb-8 md:mb-0">
          <h3 className="text-sm font-semibold text-zinc-900 dark:text-white ">Topic</h3>
          <ul className="mt-2 space-y-1">
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
            <li><Link href={"#"} className="text-zinc-600  dark:text-white">Page</Link></li>
